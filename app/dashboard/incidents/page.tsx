const incidents = [
  {
    ...
    time: "09:40 UTC",
    summary:
      "Failed login bursts against SSO service from 14 countries. IP reputation checks increased risk to medium-high.",
    status: "Mitigating",
  },
  {
    ...
    time: "08:15 UTC",
    summary:
      "Three devices on the finance VLAN were isolated after script execution matched a known ransomware pattern.",
    status: "Contained",
  },
  {
    ...
    time: "06:50 UTC",
    summary:
      "A service account attempted to add a new local admin and triggered SSO identity policy enforcement.",
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <h3 className="mt-2 text-3xl font-semibold text-slate-50">Timeline</h3>
      </section>
